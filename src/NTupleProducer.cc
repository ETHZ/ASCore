...
void NTupleProducer::resetTree(){
	...
	resetInt(fTgoodjet, 50);
	resetDouble(fTjpx, 50);
	resetDouble(fTjpy, 50);
	resetDouble(fTjpz, 50);
	resetDouble(fTje, 50);
	resetDouble(fTjet, 50);
	resetDouble(fTjpt, 50);
	resetDouble(fTjeta, 50);
	resetDouble(fTjphi, 50);
	resetDouble(fTjemfrac, 50);
	resetDouble(fTjID_HPD, 50);
	resetDouble(fTjID_RBX, 50);
	resetDouble(fTjID_n90Hits, 50);
	resetDouble(fTjID_SubDet1, 50);
	resetDouble(fTjID_SubDet2, 50);
	resetDouble(fTjID_SubDet3, 50);
	resetDouble(fTjID_SubDet4, 50);
	resetDouble(fTjID_resEMF, 50);
	resetDouble(fTjID_HCALTow, 50);
	resetDouble(fTjID_ECALTow, 50);
	resetDouble(fTbTagProb, 50);
	resetDouble(fTChfrac, 50);
	resetInt(fTnAssoTracks, 50);
	resetDouble(fTtrk1px, 50);
	resetDouble(fTtrk1py, 50);
	resetDouble(fTtrk1pz, 50);
	resetDouble(fTtrk2px, 50);
	resetDouble(fTtrk2py, 50);
	resetDouble(fTtrk2pz, 50);
	resetDouble(fTtrk3px, 50);
	resetDouble(fTtrk3py, 50);
	resetDouble(fTtrk3pz, 50);
	resetDouble(fTjeMinDR, 50);
	resetDouble(fTjetVtxx, 50);
	resetDouble(fTjetVtxy, 50);
	resetDouble(fTjetVtxz, 50);
	resetDouble(fTjetVtxExx, 50);
	resetDouble(fTjetVtxEyx, 50);
	resetDouble(fTjetVtxEyy, 50);
	resetDouble(fTjetVtxEzy, 50);
	resetDouble(fTjetVtxEzz, 50);
	resetDouble(fTjetVtxEzx, 50);
	resetDouble(fTjetVtxNChi2, 50);

	resetDouble(fJUNC_px_match, 50);
	resetDouble(fJUNC_py_match, 50);
	resetDouble(fJUNC_pz_match, 50);

	resetInt(fTgoodtrk, 500);
	resetDouble(fTtrkpt, 500);
	resetDouble(fTtrketa, 500);
	resetDouble(fTtrkphi, 500);
	resetDouble(fTtrknchi2, 500);
	resetDouble(fTtrknhits, 500);
