...
analyze = cms.EDAnalyzer('NTupleProducer',
	...
	tag_muisodeptk   = cms.untracked.InputTag('muons', 'muIsoDepositTk'),
	tag_muisodepec   = cms.untracked.InputTag('muons', 'ecal'),
	tag_muisodephc   = cms.untracked.InputTag('muons', 'hcal'),
	...
	tag_btag5        = cms.untracked.InputTag('newPFCombinedSecondaryVertexBPFJetTags'),
	tag_btag6        = cms.untracked.InputTag('newPFCombinedSecondaryVertexMVABPFJetTags'),
	tag_btag7        = cms.untracked.InputTag('newPFJetProbabilityBPFJetTags'),
	tag_btag8        = cms.untracked.InputTag('newPFJetBProbabilityBPFJetTags'),
	...
	tag_srcRhoForIso = cms.untracked.InputTag('kt6PFJetsForIso','rho'),
