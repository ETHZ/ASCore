...
options.output='NTupleProducer_38X_'+options.runon+'_'+options.recoType+'.root'
...
#process.analyze.tag_EBrechits    = cms.untracked.InputTag('reducedEcalRecHitsEB')
#process.analyze.tag_EErechits    = cms.untracked.InputTag('reducedEcalRecHitsEE')
#process.EcalAnomalousEventFilter.recHitsEB=cms.untracked.InputTag('reducedEcalRecHitsEB')
#process.EcalAnomalousEventFilter.recHitsEE= cms.untracked.InputTag('reducedEcalRecHitsEE')
